...
<head>
	...
	<style>
		...
		.nav-solid .nav-links a:not(.rounded-full) {
			color: #21160e;
		}
		...
		.nav-solid .rounded-full {
			border-color: rgba(33, 22, 14, 0.3);
			color: #21160e;
		}
		...
		document.addEventListener('DOMContentLoaded', function() {
			...
			const navObserver = new IntersectionObserver((entries) => {
				entries.forEach((entry) => {
					nav.classList.toggle('nav-solid', !entry.isIntersecting || entry
...
<body class="bg-ivory text-ink font-sans selection:bg-gold-400 selection:text-ink">
	...
	<nav id="main-nav" class="fixed w-full top-0 z-50 px-6 md:px-16 py-4 transition-all duration-500">
		<div class="max-w-7xl mx-auto flex justify-between items-center">
			<a href="/" class="flex items-center gap-2 group">
				<img src="{{ asset('assets/images/chlogo.png') }}"
					class="w-16 transition-transform duration-300 group-hover:scale-105" alt="Caree Hotel Logo">
			</a>

			<div
				class="hidden md:flex space-x-10 font-sans text-xs uppercase tracking-[0.18em] text-white/90 items-center nav-links font-medium">
				...
				@auth
					<a href="{{ route('dashboard') }}" title="Go to dashboard"
						...
						<span
							class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border border-white/40 bg-gradient-to-br from-gold-200/80 to-gold-500/70 text-[10px] font-bold text-ink shadow-inner">
							@if (auth()->user()->avatar)
	...
	<section class="relative min-h-screen flex items-center overflow-hidden bg-cover bg-center scroll-mt-24" id="home"
		...
		<div
			class="absolute inset-0 z-[5] pointer-events-none bg-[radial-gradient(circle_at_top_left,_rgba(255,223,130,0.25),transparent_30%),linear-gradient(90deg,_rgba(248,242,234,0.08)_0%,_rgba(248,242,234,0.15)_25%,_transparent_60%)]">
		</div>

		<div
			class="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-16 py-32 md:py-20 flex flex-col md:flex-row items-center gap-14 md:gap-12 justify-between">

			<div class="max-w-xl">
				<div
					class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/8 border border-gold-300/40 mb-6 backdrop-blur-sm shadow-[0_0_30px_rgba(201,150,12,0.15)]">
				...
				<p class="mt-6 text-base md:text-lg leading-relaxed text-white/75 max-w-md font-light">
					A quiet retreat where modern luxury meets Bulan's slower pace — tailored by the room, the view, and the moments
					that matter.
				</p>
			...
			<div class="w-full max-w-[320px] md:max-w-[380px] lg:max-w-[420px] shrink-0">
				<div class="relative flex items-center gap-3">
					...
					<div id="hero-carousel"
						class="relative min-w-0 flex-1 rounded-[2rem] p-3 glass-panel shadow-[0_25px_60px_rgba(0,0,0,0.5)]">
						<div class="relative rounded-[1.5rem] overflow-hidden aspect-[3/4]">

							<div class="hero-slide is-active absolute inset-0 bg-cover bg-center" data-title="Standard Suite"
								data-price="₱1,500 / night"
								style="background-image: linear-gradient(to top, rgba(17,12,10,0.9) 0%, rgba(17,12,10,0.2) 60%, rgba(17,12,10,0) 100%), url('{{ asset('assets/images/sRoom.png') }}')">
							</div>

							<div class="hero-slide absolute inset-0 bg-cover bg-center" data-title="Standard Premium"
								data-price="₱1,900 / night"
								style="background-image: linear-gradient(to top, rgba(17,12,10,0.9) 0%, rgba(17,12,10,0.2) 60%, rgba(17,12,10,0) 100%), url('{{ asset('assets/images/pRoom.png') }}')">
							</div>

							<div class="hero-slide absolute inset-0 bg-cover bg-center" data-title="Family Residence"
								data-price="₱2,700 / night"
								style="background-image: linear-gradient(to top, rgba(17,12,10,0.9) 0%, rgba(17,12,10,0.2) 60%, rgba(17,12,10,0) 100%), url('{{ asset('assets/images/fRoom.png') }}')">
							</div>

							<div class="absolute top-4 right-4 z-10">
								<span
									class="bg-[#1d120d]/65 backdrop-blur-md border border-gold-300/25 text-gold-200 text-[10px] font-semibold uppercase tracking-[0.22em] px-3 py-1.5 rounded-full">
							...
							<div class="absolute bottom-6 left-6 right-6 z-10">
								<div id="hero-caption-box" class="transition-all duration-300" aria-live="polite">
									<h4 id="hero-room-title" class="text-white font-display text-3xl font-medium tracking-wide">Standard Suite
									</h4>
								...
								<div class="flex gap-2.5 mt-5">
									<button type="button"
										class="hero-dot is-active relative h-1 flex-1 rounded-full bg-white/20 overflow-hidden"
										aria-label="Slide 1">
										<div class="hero-progress-bar h-full bg-gold-300 rounded-full"></div>
									</button>
									<button type="button" class="hero-dot relative h-1 flex-1 rounded-full bg-white/20 overflow-hidden"
										aria-label="Slide 2">
										<div class="hero-progress-bar h-full bg-gold-300 rounded-full"></div>
									</button>
									<button type="button" class="hero-dot relative h-1 flex-1 rounded-full bg-white/20 overflow-hidden"
		...
		<div class="max-w-7xl mx-auto">
			<div class="mb-20 max-w-2xl">
				...
				<p class="mt-4 text-[#5d4c3d] text-base leading-relaxed max-w-xl font-light">
					Every detail designed with intent. Rates are curated by space, vista, and bespoke features so you pay only for what
					you desire.
				</p>
			</div>
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
				...
				<div
					class="group warm-card rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(35,24,14,0.08)] hover:shadow-[0_25px_60px_rgba(35,24,14,0.14)] hover:-translate-y-1.5 transition-all duration-500 flex flex-col">
					<div class="relative overflow-hidden h-64 bg-gold-50">
						...
						<span
							class="absolute top-5 right-5 bg-ink/80 backdrop-blur-md text-ivory text-[11px] font-medium px-4 py-1.5 rounded-full tracking-wider uppercase">
							Standard
						</span>
					</div>
					<div class="p-8 flex flex-col flex-1">
								...
								<span class="w-8 h-8 rounded-full bg-gold-50 flex items-center justify-center text-gold-600 shrink-0">
									<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
										<path stroke-linecap="round" stroke-linejoin="round"
											d="M3 18v-6a2 2 0 012-2h14a2 2 0 012 2v6M3 18h18M3 18v2M21 18v2M7 10V7a2 2 0 012-2h6a2 2 0 012 2v3" />
									</svg>
								</span>
						...
						<div class="pt-6 border-t border-ink/5 flex items-center justify-between mt-auto">
							...
							@auth
								<a href="{{ route('booking.new.wizard', ['roomType' => 'standard']) }}"
				...
				<div
					class="group bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(15,26,34,0.05)] hover:shadow-[0_25px_60px_rgba(15,26,34,0.12)] hover:-translate-y-1.5 transition-all duration-500 flex flex-col border border-gold-400/20 relative">
					<div class="relative overflow-hidden h-64 bg-gold-50">
						<img src="{{ asset('assets/images/pRoom.png') }}" alt="Standard Premium Room" loading="lazy"
							class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
						<span
							class="absolute top-5 right-5 bg-gold-500 text-ink text-[11px] font-semibold px-4 py-1.5 rounded-full tracking-wider uppercase shadow-sm">
							Premium
						</span>
					</div>
					<div class="p-8 flex flex-col flex-1">
						...
						<div class="pt-6 border-t border-ink/5 flex items-center justify-between mt-auto">
							...
							@auth
								<a href="{{ route('booking.new.wizard', ['roomType' => 'standard-premium']) }}"
									class="inline-flex items-center gap-2 bg-ink hover:bg-gold-500 text-white font-medium text-xs uppercase tracking-wider px-5 py-3 rounded-full transition-all duration-300">
									Reserve
									<svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
										<path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
							...
							@else
								<a href="{{ route('customize.booking', ['roomType' => 'standard-premium']) }}"
									...
									Reserve
									<svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
										<path stroke-linecap="round" stroke-linejoin="round" d="M17 8l-4 4m0 0l-4 4m4-4H3" />
									</svg>
								</a>
							@endauth
						</div>
				...
				<div
					class="group bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(15,26,34,0.05)] hover:shadow-[0_25px_60px_rgba(15,26,34,0.12)] hover:-translate-y-1.5 transition-all duration-500 flex flex-col border border-ink/5">
					<div class="relative overflow-hidden h-64 bg-gold-50">
					...
					<div class="p-8 flex flex-col flex-1">
						...
						<div class="pt-6 border-t border-ink/5 flex items-center justify-between mt-auto">
							...
							@auth
								<a href="{{ route('booking.new.wizard', ['roomType' => 'family']) }}"
									class="inline-flex items-center gap-2 bg-ink hover:bg-gold-500 text-white font-medium text-xs uppercase tracking-wider px-5 py-3 rounded-full transition-all duration-300">
									Reserve
									<svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
										<path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
	...
	<section class="py-32 px-6 md:px-16 bg-[#fffdf9] scroll-mt-24 border-t border-b border-[#e7d8b5]" id="about-us">
		<div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
			...
			<div class="flex-1">
				...
				<div class="space-y-8">
					<div class="flex gap-6 items-start">
						<div
							class="bg-gold-50 border border-gold-200/50 w-14 h-14 flex items-center justify-center rounded-2xl text-gold-600 flex-shrink-0">
			...
			<div class="flex-1 w-full">
				<div
					class="relative rounded-3xl overflow-hidden shadow-[0_30px_70px_rgba(15,26,34,0.1)] p-2 bg-ivory border border-ink/5">
		...
		<div class="max-w-7xl mx-auto w-full">
			<div class="max-w-3xl">
				...
				<p class="mt-8 text-base md:text-lg leading-relaxed text-white/80 max-w-xl font-light">
					Founded in 2016, Caree Hotel was established to bring international standards of hospitality to the heart of Bulan
					— a quiet, refined sanctuary where every guest can rest and unwind.
				</p>
