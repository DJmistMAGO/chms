    ...
    <div class="relative z-10 w-full max-w-sm mx-4">
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl px-8 py-9 card-enter">
                ...
                <form action="{{ route('login.post') }}" method="POST" class="space-y-5" data-confirm-leave>
                    ...
                    <div class="space-y-1">
                        <div class="flex justify-between items-center">
                            ...
                            <button type="button" onclick="showForgotPassword()" class="text-xs text-amber-600 hover:text-amber-700 transition font-medium">Forgot password?</button>
                        </div>
                        <div class="relative">
                            <input
                                type="password"
            ...
            <div id="forgotPasswordView" class="hidden">
                ...
                <p class="text-center text-stone-400 text-xs mb-7 font-light leading-relaxed">Enter your registered email address and we'll send you a link to reset your password.</p>
                ...
                <p class="text-center text-stone-400 text-xs mt-6">
                    ...
                    <button type="button" onclick="showLogin()" class="text-amber-600 font-medium hover:text-amber-700 transition">Back to Sign In</button>
                </p>
            </div>
