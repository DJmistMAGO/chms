...
<body class="min-h-screen flex items-center justify-center bg-cover bg-fixed bg-center relative py-8"
    ...
    <div class="relative z-10 w-full max-w-sm mx-4">
        <div class="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl px-8 py-9 card-enter">
            ...
            <form action="{{ route('signup.post') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-1">
                    <label class="block text-xs font-medium text-stone-500 tracking-widest uppercase">Full Name</label>
                    <input
                        type="text"
                        name="name"
                ...
                <button type="submit"
                    class="btn-primary w-full text-white py-3 rounded-xl font-medium tracking-wide text-sm shadow-md mt-1">
                    Create Account
                </button>
            </form>
