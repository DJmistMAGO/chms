...
@section('content')
                            ...
                            <tr class="booking-row group transition-colors hover:bg-orange-50/40 dark:hover:bg-orange-400/5"
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-orange-100 text-xs font-bold text-orange-700 dark:bg-orange-400/20 dark:text-orange-300">
                                            {{ $initials }}
                                        </div>
                                        <div>
                                ...
                                {{-- Status --}}
                                <td class="status-cell px-5 py-4">
    @php
        $status = strtolower($b->status);

        $badgeClasses = match ($status) {
            'completed' => 'bg-green-50 text-green-700 ring-green-200 dark:bg-green-400/10 dark:text-green-400 dark:ring-green-400/20',
            'cancelled' => 'bg-red-50 text-red-700 ring-red-200 dark:bg-red-400/10 dark:text-red-400 dark:ring-red-400/20',
            'archived' => 'bg-gray-50 text-gray-700 ring-gray-200 dark:bg-gray-400/10 dark:text-gray-400 dark:ring-gray-400/20',
            default => 'bg-orange-50 text-orange-700 ring-orange-200 dark:bg-orange-400/10 dark:text-orange-400 dark:ring-orange-400/20',
        };
    ...
    <span
        class="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold ring-1 {{ $badgeClasses }}">
                                    ...
                                    <div class="flex items-center justify-center gap-1.5">
                                        ...
                                        <button title="Delete booking"
                                            ...
                                            <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2.5"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M19 7L18 20H6L5 7M10 11v6M14 11v6M4 7h16M9 7V4h6v3" />
                                            </svg>
                                        </button>
                            ...
                            <tr>
                                <td colspan="7" class="py-16 text-center">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">No booking history
                                        </p>
        ...
        <div x-show="detailModal" x-cloak
            ...
            <div @click.away="detailModal=false"
                ...
                <div class="px-5 py-4 space-y-4">
                    <div class="flex items-center gap-3 rounded-xl bg-orange-50 px-3 py-2.5 dark:bg-orange-400/10">
                        <span class="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-orange-400/30">
                            <svg class="h-3.5 w-3.5 text-orange-700" fill="none" stroke="currentColor"
                                stroke-width="1.8" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="truncate text-sm font-semibold text-orange-900 dark:text-orange-300"
                                x-text="selectedBooking.room_type || '—'"></p>
                            <p class="text-xs text-orange-700/60"
                                x-text="(selectedBooking.number_of_guests || '—') + ' guest(s)'"></p>
                        </div>
                        <span
                            class="flex-shrink-0 rounded-full bg-orange-200/60 px-2 py-0.5 text-xs font-semibold text-orange-800"
                    ...
                    <div
                        class="rounded-xl border border-orange-100 bg-orange-50/50 px-3 py-3 dark:border-orange-400/10 dark:bg-orange-400/5">
                        <div class="space-y-1.5 text-sm">
                            ...
                            <div
                                class="flex justify-between border-t border-orange-200/60 pt-1.5 dark:border-orange-400/10">
        ...
        <div x-show="assignModal" x-cloak
            ...
            <div @click.away="assignModal=false" class="w-full max-w-md rounded-3xl bg-white shadow-2xl dark:bg-gray-900"
                ...
                <div class="rounded-t-3xl bg-orange-500 px-6 py-5 flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-bold text-white">Confirm Booking</h3>
                        <p class="mt-0.5 text-xs text-orange-100" x-text="'Ref: ' + selectedRef"></p>
                    </div>
                ...
                <form method="POST" x-bind:action="'{{ url('booking/confirm') }}/' + selectedRef">
                    ...
                    <div class="px-6 py-5">
                        <label class="mb-1.5 block text-xs font-medium uppercase tracking-widest text-gray-400">Assign
                            Room</label>
                        <select name="room_id"
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 transition focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-400/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                    ...
                    <div class="flex justify-end gap-3 border-t border-gray-100 px-6 py-4 dark:border-gray-800">
                        ...
                        <button type="submit"
                            class="rounded-xl bg-orange-500 px-5 py-2 text-sm font-semibold text-white hover:bg-orange-600 active:scale-95">Confirm
                            Booking</button>
                    </div>
                </form>
            </div>
