                                    ...
                                    <tr>
                                        <td colspan="7" class="py-16 text-center">
                                            <div class="flex flex-col items-center gap-2">
                                                ...
                                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">No booking
                                                    history
                                                </p>
                                                <p class="text-xs text-gray-400">All caught up! No reservations need
                                                    attention.</p>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <div x-show="assignModal" x-cloak
                    ...
                    <div @click.away="assignModal=false"
                        ...
                        <form method="POST" x-bind:action="'{{ url('booking/confirm') }}/' + selectedRef">
                            ...
                            <div class="px-6 py-5">
                                <label
                                    class="mb-1.5 block text-xs font-medium uppercase tracking-widest text-gray-400">Assign
                                    Room</label>
                                <select name="room_id"
                        ...
                        <form method="POST" x-bind:action="">
                            ...
                            <div class="px-6 py-5">
                                <p class="text-sm text-gray-500 dark:text-gray-400">This will mark the booking as <span
                                        class="font-semibold text-amber-600">cancelled</span>. The guest will be notified.
                                </p>
                                <div class="mt-4">
                                    <label
                                        class="mb-1.5 block text-xs font-medium uppercase tracking-widest text-gray-400">Reason
                                        (optional)</label>
                        ...
                        <form method="POST" x-bind:action="">
                            ...
                            <div class="px-6 py-5">
                                <div class="flex items-start gap-3 rounded-xl bg-red-50 p-4 dark:bg-red-400/10">
                                    <svg class="mt-0.5 h-5 w-5 flex-shrink-0 text-red-500" fill="none"
                                        stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                                    </svg>
                                    <p class="text-sm text-red-700 dark:text-red-300">This action <span
                                            class="font-bold">cannot
