                                        ...
                                        <td class="status-cell px-5 py-4">
                                            @php
                                                ...
                                                $badgeClasses = match ($status) {
                                                    'completed'
                                                        => 'bg-green-50 text-green-700 ring-green-200 dark:bg-green-400/10 dark:text-green-400 dark:ring-green-400/20',
                                                    'cancelled'
                                                        => 'bg-red-50 text-red-700 ring-red-200 dark:bg-red-400/10 dark:text-red-400 dark:ring-red-400/20',
                                                    'archived'
                                                        => 'bg-gray-50 text-gray-700 ring-gray-200 dark:bg-gray-400/10 dark:text-gray-400 dark:ring-gray-400/20',
                                                    default
                                                        => 'bg-orange-50 text-orange-700 ring-orange-200 dark:bg-orange-400/10 dark:text-orange-400 dark:ring-orange-400/20',
                                                };
