                        ...
                        <tr>
                            <td colspan="7" class="py-16 text-center">
                                <div class="flex flex-col items-center gap-2">
                                    <span class="flex h-12 w-12 items-center justify-center rounded-full bg-orange-50 dark:bg-orange-400/10">
                                        <svg class="h-5 w-5 text-orange-400" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            ...
            <div class="px-5 py-4 space-y-4">
                <div class="flex items-center gap-3 rounded-xl bg-orange-50 px-3 py-2.5 dark:bg-orange-400/10">
                    <span class="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-orange-400/30">
                        <svg class="h-3.5 w-3.5 text-orange-700" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="truncate text-sm font-semibold text-orange-900 dark:text-orange-300" x-text="selectedBooking.room_type || '—'"></p>
                        <p class="text-xs text-orange-700/60" x-text="(selectedBooking.number_of_guests || '—') + ' guest(s)'"></p>
                    </div>
                    <span class="flex-shrink-0 rounded-full bg-orange-200/60 px-2 py-0.5 text-xs font-semibold text-orange-800" x-text="(selectedBooking.nights || '—') + 'N'"></span>
                </div>
                ...
                <div class="rounded-xl border border-orange-100 bg-orange-50/50 px-3 py-3 dark:border-orange-400/10 dark:bg-orange-400/5">
                    <div class="space-y-1.5 text-sm">
                        ...
                        <div class="flex justify-between border-t border-orange-200/60 pt-1.5 dark:border-orange-400/10">
    ...
    <div x-show="assignModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm"
        ...
        <div @click.away="assignModal=false" class="w-full max-w-md rounded-3xl bg-white shadow-2xl dark:bg-gray-900"
            ...
            <div class="rounded-t-3xl bg-orange-500 px-6 py-5 flex items-center justify-between">
                ...
                <button @click="assignModal=false" class="flex h-8 w-8 items-center justify-center rounded-full bg-white/20 text-white hover:bg-white/30">
            ...
            <form method="POST" x-bind:action="'{{ url('booking/confirm') }}/' + selectedRef">
                ...
                <div class="px-6 py-5">
                    <label class="mb-1.5 block text-xs font-medium uppercase tracking-widest text-gray-400">Assign Room</label>
                    <select name="room_id" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 transition focus:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-400/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                ...
                <div class="flex justify-end gap-3 border-t border-gray-100 px-6 py-4 dark:border-gray-800">
                    <button type="button" @click="assignModal=false" class="rounded-xl border border-gray-200 px-4 py-2 text-sm text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400">Cancel</button>
                    <button type="submit" class="rounded-xl bg-orange-500 px-5 py-2 text-sm font-semibold text-white hover:bg-orange-600 active:scale-95">Confirm Booking</button>
                </div>
            </form>
        </div>
    </div>
