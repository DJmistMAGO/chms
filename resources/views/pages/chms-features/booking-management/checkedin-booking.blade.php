                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-800" id="bookings-tbody">
                        @forelse ($checkedInBookings as $b)
                            @php
                                ...
                                $guest = $b->user;
                                $room = $b->room;
                                $guestName = $isOnline ? optional($guest)->name ?? 'Registered Guest' : $b->fullname ?? '—';
                            ...
                            <tr class="booking-row group transition-colors hover:bg-orange-50/40 dark:hover:bg-orange-400/5"
                                ...
                                {{ $isOnline
                                    ...
                                    : 'bg-yellow-100 text-yellow-700 dark:bg-yellow-400/20 dark:text-yellow-300' }}">
                                        ...
                                        <div>
                                            <p class="font-semibold text-gray-800 dark:text-white">{{ $guestName }}</p>
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    booked_at:             @js($bookedAt)
                                        ...
                                        {{-- Checkout / Complete --}}
                                        <button title="Mark as Checked Out"
                                            @click="selectedId=@js($b->id); selectedBookingType=@js($bookingType); selectedRef=@js($referenceNumber); selectedRoomType=@js($roomType); assignModal=true"
                            ...
                            <tr>
                                <td colspan="8" class="py-16 text-center">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">No checked-in
                                            bookings</p>
                                        <p class="text-xs text-gray-400">All caught up! No guests are currently checked in.
                                        </p>
                                    </div>
                                </td>
                            </tr>
            ...
            <div x-show="detailModal" x-cloak
                ...
                <div @click.away="detailModal=false"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 px-6 py-5">
                        ...
                        <div class="space-y-2">
                            <p class="mb-1 text-xs font-semibold uppercase tracking-widest text-gray-400">Stay Preferences
                            </p>
                        ...
                        <div class="px-6 py-5">
                            <div class="flex items-start gap-3 rounded-xl bg-red-50 p-4 dark:bg-red-400/10">
                                ...
                                <p class="text-sm text-red-700 dark:text-red-300">This action <span
                                        class="font-bold">cannot be undone.</span> The booking record will be permanently
                                    deleted.</p>
                            </div>
                        </div>
                        <div class="flex justify-end gap-3 border-t border-gray-100 px-6 py-4 dark:border-gray-800">
