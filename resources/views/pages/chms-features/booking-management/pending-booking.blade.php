        ...
        <div @click.away="detailModal=false" class="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-900"
            ...
            <div class="px-5 py-4 space-y-4">
                <div class="flex items-center gap-3 rounded-xl bg-yellow-50 px-3 py-2.5 dark:bg-yellow-400/10">
                    <span class="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-yellow-400/30">
                        <svg class="h-3.5 w-3.5 text-yellow-700" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="truncate text-sm font-semibold text-yellow-900 dark:text-yellow-300" x-text="selectedBooking.room_type || '—'"></p>
                        <p class="text-xs text-yellow-700/60" x-text="(selectedBooking.number_of_guests || '—') + ' guest(s)'"></p>
                    </div>
                    <span class="flex-shrink-0 rounded-full bg-yellow-200/60 px-2 py-0.5 text-xs font-semibold text-yellow-800" x-text="(selectedBooking.nights || '—') + 'N'"></span>
                </div>
                ...
                <div class="rounded-xl border border-yellow-100 bg-yellow-50/50 px-3 py-3 dark:border-yellow-400/10 dark:bg-yellow-400/5">
                    <div class="space-y-1.5 text-sm">
                        ...
                        <div class="flex justify-between border-t border-yellow-200/60 pt-1.5 dark:border-yellow-400/10">
        ...
        <div @click.away="assignModal=false" class="w-full max-w-md rounded-3xl bg-white shadow-2xl dark:bg-gray-900"
            ...
            <form method="POST" x-bind:action="'{{ url('booking/confirm') }}/' + selectedRef">
                ...
                <div class="px-6 py-5">
                    ...
                    <select name="room_id" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 transition focus:border-green-400 focus:outline-none focus:ring-2 focus:ring-green-400/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                ...
                <div class="flex justify-end gap-3 border-t border-gray-100 px-6 py-4 dark:border-gray-800">
                    ...
                    <button type="submit" class="rounded-xl bg-green-500 px-5 py-2 text-sm font-semibold text-white hover:bg-green-600 active:scale-95">Confirm Booking</button>
                </div>
            </form>
        </div>
    </div>
