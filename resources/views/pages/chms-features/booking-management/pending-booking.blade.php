                            ...
                            <tr class="booking-row group transition-colors hover:bg-yellow-50/40 dark:hover:bg-yellow-400/5"
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <p class="mt-0.5 text-xs text-gray-400">
                                        ...
                                        night{{ $booking->check_in->diffInDays($booking->check_out) == 1 ? '' : 's' }}
                                    </p>
                                </td>
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center justify-center gap-1.5">
                                        {{-- View Details --}}
                                        <button data-reference-number="{{ $booking->reference_number }}"
                                            ...
                                            data-booked-at="{{ $booking->created_at->format('M j, Y, g:i A') }}"
                                            ...
                                            nights: $el.dataset.nights,
                                            booked_at: $el.dataset.bookedAt
                                        }; detailModal=true"
                                        ...
                                        <button
                                            @click="
                                                    ...
                                                    selectedRef='{{ $booking->reference_number }}';
            ...
            <div @click.away="detailModal=false"
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div
                            ...
                            <p class="mt-0.5 text-sm font-semibold text-gray-800 dark:text-white"
                                x-text="selectedBooking.check_in || '—'"></p>
                        </div>
                        <div
                            class="rounded-xl border border-gray-100 bg-gray-50 px-3 py-2.5 dark:border-gray-800 dark:bg-white/5">
                            <p class="text-xs text-gray-400">Check-out</p>
                            <p class="mt-0.5 text-sm font-semibold text-gray-800 dark:text-white"
                                x-text="selectedBooking.check_out || '—'"></p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-1.5 text-sm">
                            <div class="flex justify-between text-gray-500 dark:text-gray-400">
                                <span>Room rate</span>
                                <span x-text="selectedBooking.room_price ? '₱' + selectedBooking.room_price : '—'"></span>
                            </div>
                            <div class="flex justify-between text-gray-500 dark:text-gray-400">
                                <span>Add-ons</span>
                                <span
                ...
                <div class="flex items-center justify-between border-t border-gray-100 px-5 py-3 dark:border-gray-800">
                    <p class="text-xs text-gray-400">
                        Booked <span class="text-gray-500 dark:text-gray-300"
                            x-text="selectedBooking.booked_at || '—'"></span>
                    </p>
                    <button type="button" @click="detailModal=false"
                        class="rounded-xl border border-gray-200 px-4 py-1.5 text-xs font-medium text-gray-600 transition hover:bg-gray-50 active:scale-95 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/5">
                        Close
                    </button>
                </div>
                ...
                <form method="POST" x-bind:action="">
                    ...
                    <div class="px-6 py-5">
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            This will mark the booking as <span class="font-semibold text-amber-600">cancelled</span>. The
                    ...
                    <div class="px-6 py-5">
                        <div class="flex items-start gap-3 rounded-xl bg-red-50 p-4 dark:bg-red-400/10">
                            ...
                            <p class="text-sm text-red-700 dark:text-red-300">
                                This action <span class="font-bold">cannot be undone.</span> The booking record will be
                                permanently deleted.
                            </p>
                        </div>
                    </div>
